...
class EventDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          Expanded(
                            child: _buildQuickInfoCard(
                              ...
                              'Tanggal',
                              DateFormat('d MMM yyyy', 'id_ID').format(event.date),
                      ...
                      _buildDetailRow(FontAwesomeIcons.locationDot, 'Lokasi', event.location),
                      _buildDetailRow(FontAwesomeIcons.user, 'Penyelenggara', event.organizer),
                      _buildDetailRow(FontAwesomeIcons.envelope, 'Kontak', event.contactEmail),
                      _buildDetailRow(FontAwesomeIcons.users, 'Kapasitas', '${event.capacity} orang'),
                      _buildDetailRow(FontAwesomeIcons.tag, 'Kategori', event.category),
      ...
      // Conditionally show Floating Action Button only for paid events
      floatingActionButton: !isFree ? Container(
        width: double.infinity,
